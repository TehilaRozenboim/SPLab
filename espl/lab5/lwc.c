...
int main(int argc, char **argv) {
	...
	utoa_s(nlines, printing_buffer);
	print(printing_buffer); print(" lines\n");
	utoa_s(nwords, printing_buffer);
	print(printing_buffer); print(" words\n");
	utoa_s(nchars, printing_buffer);
	print(printing_buffer); print(" chars\n");
